...
function add_expense(){
    ...
    if (amount && date && note && selected){
        ...
        expense_per_category[category-1] = parseInt(expense_per_category[category-1]) + parseInt(amount);
        update_sum();
        console.log(count);
...
function add_category(){
    ...
    if (new_category_value){
        ...
        new_category_span.innerHTML = `<span class="avai-cat">${new_category_value}<span class="sum">${expense_per_category[count]} Rs. spent</span></span>`;
